                        ...
                        <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                            ...
                            <form action="AdminController" method="post" enctype="multipart/form-data" onsubmit = "return checkAllData()">
                                <div class="form-floating mb-3">
                                    <label for="floatingText">Product ID</label>
                                    <input type="text" name="id" class="form-control" id="floatingText" readonly  value="<%= id%>" ">
                                </div>
                                <div class="form-floating mb-3">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <textarea id="desc" class="form-control"  name="desc" rows="5" cols="10"><%= p.getProduct_desc()%></textarea>

                                </div>
                                <div class="form-floating mb-4">
                                    <label for="floatingPrice">Price</label>
                                    <input type="text" name="price" class="form-control" id="floatingPrice" value="<%= p.getSelling_price()%>"  placeholder="Password">
                                </div>
                                <div class="form-floating mb-3">
                                    <label for="floatingQuantity">Quantity</label>
                                    <input type="int" name="quantity" class="form-control" id="floatingQuantity" value="<%= p.getQuantity()%>" placeholder="0123456789">
                                </div>
                                <div class="form-floating mb-3">
                                ...
                                <div class="form-floating mb-3">
                                    <select class="form-select" id="floatingSelect" name="role"
                                        ...
                                        <%
                                            ...
                                            while (rs.next()) {
                                        %>
                                        <option <%= p.getCategory_id().equals(rs.getString("catagory_id").toString()) ? "selected" : ""%> 
                                            value="<%=  rs.getString("catagory_id")%>"><%=  rs.getString("category_name")%></option>
                                        <%
                                            }
                                        %>
                                    </select>
                                ...
                                <button type="submit" name="btn_update_product" value="Sign Up" class="btn btn-primary py-3 w-100 mb-4">Update</button>
                            </form>
